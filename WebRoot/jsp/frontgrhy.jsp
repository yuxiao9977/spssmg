...
<html lang="zh-CN">
	<head>
  		...
  		<script type="text/javascript" src="<%=path%>/js/frontgrhy.js"></script>
	...
	<body style="background:#eaeaea" onload="frontgrhy.init()">
			...
			<%@ include file="head.jsp"%>
	      	...
	      	<div style="overflow:auto;margin-top:10px">
		      	...
		      	<div class="col-xs-12" style="padding-left:20px;margin-top: 10px;">
		      		...
		      		<a href="<%=request.getContextPath()%>/jsp/frontgrhy.jsp">/个人会员</a>
		      		</div>
		      			...
		      			<table>
		      				<tr>
		      					<td>
 									 ...
 									 <input type="text" id="xm" class="form-control"  aria-describedby="basic-addon1">
									</div>
		      					</td>
		      					<td >
		      						<div class="input-group" style="margin-left: 30px;">
 									 <span class="input-group-addon" id="basic-addon1">工作单位</span>
 									 <input type="text" id="gzdw" class="form-control" aria-describedby="basic-addon1">
									</div>
		      					</td>
		      					<td>
		      						<div class="input-group" style="margin-left: 30px;">
		      					...
		      					<td>
		      						...
		      						<button type="button" onclick="frontgrhy.init();" class="btn btn-success">查询</button>
		      						</div>
		      					</td>
		      				</tr>
		      			</table>
					  ...
					  <ul class="pager" style="font-size:12px;">
					    <li class="previous"><a href="javascript:" onclick="frontgrhy.syy()">上一页</a></li>
    					<li class="next"><a href="javascript:" onclick="frontgrhy.xyy()">下一页 </a></li>
					  </ul>
					</nav>
		      	</div>
	      	</div>
