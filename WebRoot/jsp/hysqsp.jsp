...
<script type="text/javascript" src="<%=path%>/js/hysqsp.js"></script>
<style type="text/css">
* {
	font-size: 12px;
}
...
<nav class="navbar navbar-fixed-top" style="margin-left:5px;margin-right:5px;">
	...
	<div style="margin-top:40px;margin-left:10px;margin-right:10px">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#grxxgl" data-toggle="tab">个人会员审批</a>
			</li>
			<li>
				<a href="#ttxxgl"  data-toggle="tab">团体会员审批</a>
			</li>
		</ul>
	</div>
	<!-- 切换标签 结束 -->
